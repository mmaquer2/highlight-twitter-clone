...
export default function Dashboard() {
    ...
    const fetchData = async () => {
        try {
            ...
            setData(prevData => ({ ...prevData, username: userData.username, avatarLink: userData.avatar_link }));
        } catch (error) {
    ...
    return loading ? <LoadingComponent /> : <DashboardContent state={data} setData={setData} createNewPost={createNewPost} />;
}
...
const DashboardContent: React.FC<DashboardContentProps>  = ({ state, setData , createNewPost }) => (
    <div>
        <Navbar />
